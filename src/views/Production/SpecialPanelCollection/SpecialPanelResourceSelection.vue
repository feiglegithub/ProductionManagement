...
export default {
    ...
    methods: {
        ...
        changeWorkshop(value){
            ...
            localStorage.setItem('SpecialPanelCollectionWorkshopKey',this.ChoiceWorkshopId)
        ...
        changeProcess(value){
            ...
            localStorage.setItem('SpecialPanelCollectionProcessKey',this.ChoiceProcessId)
            this.ChoiceProcess = this.GetProcess.find(item=>item.Id == id).Name
            this.ChoiceResourceId=null
            this.ChoiceResource=null
            localStorage.setItem('SpecialPanelCollectionResourceKey',this.ChoiceResourceId)
        },
        //选择某一项资源
        ...
        async judgeWorkshop(){
            ...
            if (localStorage.getItem('SpecialPanelCollectionWorkshopKey')) {
                let newArr=this.GetWorkshop.filter(item=>{
                    return item.Id==localStorage.getItem('SpecialPanelCollectionWorkshopKey')
                })
                if(newArr.length>0){
                    this.ChoiceWorkshopId=localStorage.getItem('SpecialPanelCollectionWorkshopKey')
        ...
        async judgeProcess(){
            ...
            if (localStorage.getItem('SpecialPanelCollectionProcessKey')) {
                let newArr=this.GetProcess.filter(item=>{
                    return item.Id==localStorage.getItem('SpecialPanelCollectionProcessKey')
                })
                if(newArr.length>0){
                    this.ChoiceProcessId=localStorage.getItem('SpecialPanelCollectionProcessKey')
        ...
        async judgeResources(){
            ...
            if (localStorage.getItem('SpecialPanelCollectionResourceKey')) {
                let newArr=this.GetResource.filter(item=>{
                    return item.Id==localStorage.getItem('SpecialPanelCollectionResourceKey')
                })
                if(newArr.length>0){
                    this.ChoiceResourceId=localStorage.getItem('SpecialPanelCollectionResourceKey')
