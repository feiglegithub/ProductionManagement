        ...
        <div class="f-flexvw f-flexg1 f-pdlr5">
            <div class="g-inp" style="min-height:60px;">
                <div class="m-inp f-mtb5">
                    <span class="laber" style="width:24%">缺陷小类</span>
                    <div  @click="ShowSmallDefect = true" class="m-selector">
                        <popup-picker 
                            :show.sync="ShowSmallDefect" 
                            :data="SmallDefectList" 
                            @on-change="changeSmallDefect"
                            value-text-align='left'
                        ></popup-picker>
                        <div>{{ChoiceSmallDefect}}</div>
                    </div>    
                </div>
                <div class="m-inp f-mtb5">
                    <span class="laber" style="width:24%">缺陷名称</span>
                    <div  @click="ShowDefectName = true" class="m-selector">
                        <popup-picker 
                            :show.sync="ShowDefectName" 
                            :data="DefectNameList" 
                            @on-change="changeDefectName"
                            value-text-align='left'
                        ></popup-picker>
                        <div>{{ChoiceDefectName}}</div>
                    </div>    
                </div>
                <div class="m-inp f-mtb5">
                    <span class="laber" style="width:24%">条码</span>
                    <span class="inp s-inpbg">
                        <input v-model="SupportNumber" placeholder="请扫描板件条码" type="text" @keyup.enter="getSupportNumber()" class="s-inpbg" @focus="getFocus()" @blur="getBlur()">
                    </span>
                </div>
            </div>
                            ...
                            <div slot="content" class="f-pd5 vux-1px-t">
                                <div class="m-listbox">
                                    ...
                                    <div class="showbox">
                                        ...
                                        <div class="f-flexjcbw">
                                            <div class="showlistmsg">
                                                <span class="label">封边:</span>
                                                <span class="showmsg f-ml10">333</span>
                                            </div>
                                            <div class="showlistmsg">
                                                <span class="label">花色:</span>
                                                <span class="showmsg f-ml10">998989s</span>
                                            </div>
                                        </div>
                                        <div class="showlistmsg">
...
export default {
    ...
    data() {
        return {
            ...
            ShowSmallDefect:false,
            SmallDefectList:[['小类一','小类二']],
            ChoiceSmallDefect:null,

            ShowDefectName:false,
            DefectNameList:[['缺陷一','缺陷二']],
            ChoiceDefectName:null,
        }
    },
    components: {
    },
