            ...
            <div class="g-inp" style="min-height: 40px;">
                <div class="m-inp f-mtb5">
                    ...
                    <span class="inp s-inpbg">
                        <input class="s-inpbg" v-model="Upi" ref="UpiInp" placeholder="请扫描UPI条码" type="text" @keyup.enter="getUpi()">
                    </span>
                </div>
            </div>
            <div class="g-scrollbox">
                <div style="overflow-y: auto;">
                    <s-messageheader class="f-mt10" messagetitle="条码信息" v-show="UpiDataList.length >= 1"></s-messageheader>
                    <swipeout :class="{'s-border': UpiDataList.length >= 1}">
                        <swipeout-item v-for="(item, index) in UpiDataList" :key="index" transition-mode="follow">
                                ...
                                <div class="m-listbox">
                                    ...
                                    <div class="showbox">
                                        ...
                                        <div class="showlistmsg">
                                            ...
                                            <span class="showmsg f-ml10">{{item.FinalSizeInfo}}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        ...
        getUpi() {
            ...
            this.scanUpiReturnRepair(this.$route.params.WorkshopId, this.$route.params.ProcessId)
        },
        //点击删除按钮，删除当前项
        ...
        scanUpiReturnRepair(departmentId, processId) {
            ...
            this.$axiosApi.scanUpiReturnRepair(departmentId, processId, this.UpiDataList, this.Upi).then(res => {
