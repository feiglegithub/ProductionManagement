...
export default {
    ...
    methods: {
        ...
        goCollection(){
            ...
            this.$router.push({name:'SecondaryProcess',params:{
        ...
        changeWorkshop(value){
            ...
            localStorage.setItem('SecondaryProcessWorkshopKey',this.ChoiceWorkshopId)
        ...
        changeProcess(value){
            ...
            localStorage.setItem('SecondaryProcessProcessKey',this.ChoiceProcessId)
            this.ChoiceProcess = this.GetProcess.find(item=>item.Id == id).Name
            this.ChoiceResourceId=null
            this.ChoiceResource=null
            localStorage.setItem('SecondaryProcessResourceKey',this.ChoiceResourceId)
        },
        //选择某一项资源
        ...
        async judgeWorkshop(){
            ...
            if (localStorage.getItem('SecondaryProcessWorkshopKey')) {
                let newArr=this.GetWorkshop.filter(item=>{
                    return item.Id==localStorage.getItem('SecondaryProcessWorkshopKey')
                })
                if(newArr.length>0){
                    this.ChoiceWorkshopId=localStorage.getItem('SecondaryProcessWorkshopKey')
        ...
        async judgeProcess(){
            ...
            if (localStorage.getItem('SecondaryProcessProcessKey')) {
                let newArr=this.GetProcess.filter(item=>{
                    return item.Id==localStorage.getItem('SecondaryProcessProcessKey')
                })
                if(newArr.length>0){
                    this.ChoiceProcessId=localStorage.getItem('SecondaryProcessProcessKey')
        ...
        async judgeResources(){
            ...
            if (localStorage.getItem('SecondaryProcessResourceKey')) {
                let newArr=this.GetResource.filter(item=>{
                    return item.Id==localStorage.getItem('SecondaryProcessResourceKey')
                })
                if(newArr.length>0){
                    this.ChoiceResourceId=localStorage.getItem('SecondaryProcessResourceKey')
