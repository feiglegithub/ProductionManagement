    ...
    <div class="g-index">
        ...
        <div class="f-flexvw f-flexg1 f-pdlr5">
            <div class="g-inp" style="min-height:100px;">
                ...
                <div class="m-inp f-mtb5">
                    <span class="laber100">垫板号</span>
                    <span class="inp s-inpbg">
                        <input v-model="PlateCode" ref="PlateInp" placeholder="请扫描垫板号" type="text" @keyup.enter="getPlateCode()" class="s-inpbg">
                    </span>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        doPost(){
            ...
            console.log(`${this.PostUPI}`);
            this.changePlateCodeNotSubmit(this.$route.params.WorkshopId,this.$route.params.ProcessId,this.$route.params.ResourceManageId,this.PlateCode,this.PostUPI)
        },
        //接口：获取Upi信息
        ...
        //接口：提交二次加工单
        changePlateCodeNotSubmit(departmentId,processId,resourcesId,newPlateCode,upis){
            this.loadingtitle = '提交中'
            this.showThost = true

            this.$axiosApi.changePlateCodeNotSubmit(departmentId,processId,resourcesId,newPlateCode,upis).then(res=>{
                this.showThost=false
