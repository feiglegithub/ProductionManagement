...
export default function (packageCollectDatas,worker,workshopId,processId,resourceId) {
    return Vue.axios.post(Storage.url(), {
      "ApiType": "PagkageCollectApiController",
      "Parameters": [
        {
          "Value": packageCollectDatas
        },
        {
          "Value": worker
        },
